      ...
      <div className="container py-6 md:py-12 max-w-4xl px-4">
        ...
        <Card className="p-4 md:p-8 space-y-6 md:space-y-8">
          <div className="space-y-3 md:space-y-4">
            ...
            <p className="text-sm md:text-base text-muted-foreground">Последнее обновление: {new Date().toLocaleDateString('ru-RU')}</p>
          </div>
          ...
          <div className="space-y-6 md:space-y-8">
            ...
            <section className="space-y-2 md:space-y-3">
              <h2 className="text-xl md:text-2xl font-semibold">2. Сбор и использование данных Steam</h2>
              <p className="text-sm md:text-base text-muted-foreground leading-relaxed">
            ...
            <section className="space-y-2 md:space-y-3">
              <h2 className="text-xl md:text-2xl font-semibold">3. Ежедневный бонус и виртуальная валюта</h2>
            ...
            <section className="space-y-2 md:space-y-3">
              <h2 className="text-xl md:text-2xl font-semibold">4. Cookies и технологии отслеживания</h2>
              <p className="text-sm md:text-base text-muted-foreground leading-relaxed">
            ...
            <section className="space-y-2 md:space-y-3">
              <h2 className="text-xl md:text-2xl font-semibold">5. Защита персональных данных</h2>
              <p className="text-sm md:text-base text-muted-foreground leading-relaxed">
            ...
            <section className="space-y-2 md:space-y-3">
              <h2 className="text-xl md:text-2xl font-semibold">6. Передача данных третьим лицам</h2>
              <p className="text-sm md:text-base text-muted-foreground leading-relaxed">
            ...
            <section className="space-y-2 md:space-y-3">
              <h2 className="text-xl md:text-2xl font-semibold">7. Права пользователей</h2>
              <p className="text-sm md:text-base text-muted-foreground leading-relaxed">
            ...
            <section className="space-y-2 md:space-y-3">
              <h2 className="text-xl md:text-2xl font-semibold">8. Соответствие законодательству РФ</h2>
              <p className="text-sm md:text-base text-muted-foreground leading-relaxed">
            ...
            <section className="space-y-2 md:space-y-3">
              <h2 className="text-xl md:text-2xl font-semibold">9. Изменения Политики конфиденциальности</h2>
              <p className="text-sm md:text-base text-muted-foreground leading-relaxed">
