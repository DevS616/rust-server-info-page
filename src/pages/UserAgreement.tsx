        ...
        <Card className="p-8 max-w-4xl mx-auto">
          ...
          <div className="bg-amber-500/10 border border-amber-500/30 rounded-lg p-4 mb-6">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              ...
              Продавцом товаров/услуг выступает ИП Васенин Алексей Павлович (ИНН: 434587444042).
            </p>
          ...
          <div className="space-y-6 text-sm">
            ...
            <section>
              ...
              <div className="text-muted-foreground space-y-2">
                ...
                <p><strong>Продавец / Администрация</strong> — ИП Васенин Алексей Павлович (ИНН: 434587444042), владелец игрового проекта DevilRust, размещающий предложения на Страницах магазина, принимающий оплату и исполняющий обязательства перед Покупателем.</p>
            ...
            <section>
              ...
              <div className="text-muted-foreground space-y-1">
                <p><strong>Продавец:</strong> ИП Васенин Алексей Павлович</p>
