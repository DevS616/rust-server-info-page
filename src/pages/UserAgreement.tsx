        ...
        <Card className="p-8 max-w-4xl mx-auto">
          ...
          <div className="space-y-6 text-sm">
            ...
            <section>
              ...
              <p className="text-muted-foreground mb-2">
                3.1. Настоящее соглашение не является публичной офертой в смысле ч. 2 ст. 437 Гражданского 
                кодекса Российской Федерации. Конкретные условия приобретения цифровых товаров и услуг 
                размещены на платформе Донат магазин.
              </p>
              <p className="text-muted-foreground mb-2">
                3.2. Администрация предоставляет платные и бесплатные услуги в рамках игрового сервера.
              </p>
              <p className="text-muted-foreground mb-2">
                3.3. Платные услуги включают в себя внутриигровые предметы, премиум-статусы, донат-привилегии 
                и другие цифровые товары.
              </p>
              <p className="text-muted-foreground mb-2">
                3.4. Оплата производится через интегрированные платежные системы. Все цены указаны в рублях РФ.
              </p>
              <p className="text-muted-foreground">
                3.5. После оплаты услуги предоставляются в течение 24 часов. В случае технических проблем 
