      ...
      <div className="container mx-auto p-3 md:p-6">
        ...
        <Tabs defaultValue="tickets" className="w-full">
          <TabsList className="grid w-full grid-cols-3 sm:grid-cols-7 h-auto gap-1">
            ...
            <TabsTrigger value="economy" className="text-xs md:text-sm px-1.5 py-2 md:py-2.5 flex-col sm:flex-row gap-0.5 sm:gap-2">
              <Icon name="Coins" className="h-4 w-4" />
              <span className="text-[10px] sm:text-xs md:text-sm">Экономика</span>
            </TabsTrigger>
          </TabsList>
